...
class Train (models.Model):
    ...
    class Meta:
        verbose_name=u'Поезд'
        verbose_name_plural=u'Поезда'
...
class TrainTest (models.Model):
    name = models.CharField(max_length=50, unique=True, verbose_name = "Номер поезда")
    from_city = models.ForeignKey(City, on_delete=models.CASCADE, verbose_name="Из какого города", related_name = "from_city",)
